...
<Row>
        <Col className='team' >  <h1>Meet our talented team</h1>   </Col>
      </Row>
      ...
      <Row className="justify-content-center">
          <Col md={4}>
            <Card className="message">
              <Card.Body>
                ...
                <Card.Img variant="top" src="./photo/uday.jpg" className="card-image" />
                 
                <Card.Text>  Uday Narsale </Card.Text>
          ...
          <Col md={4}>
            <Card className="message">
              ...
              <Card.Img variant="top" src="./photo/shreeniwas.jpg" />
                
              
                 
                <Card.Text>  Shreeniwas Kate</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4}>
            <Card className="message">
              ...
              <Card.Img variant="top" src='/photo/arati.jpg' />
              
                 
                  <Card.Text> Arati Somwanshi</Card.Text>
